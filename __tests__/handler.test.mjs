...
jest.mock('aws-sdk', () => {
    ...
    const mockScan = jest.fn(() => ({
        promise: () => Promise.resolve({
            Items: [
                { user_id: 'user1', position_new: position_new.user1, aggregate_skills_season: aggregate_skills_season.user1 },
                { user_id: 'user2', position_new: position_new.user2, aggregate_skills_season: aggregate_skills_season.user2 },
            ]
        })
    }));
